package com.blz.ServiceImplementation;
...
import com.blz.Responce.MailObject;
import com.blz.Responce.MailResponce;
import com.blz.Sevice.UserService;
import com.blz.customexceptions.EmailAlreadyExistException;
import com.blz.customexceptions.EmailNotFoundException;
import com.blz.customexceptions.UserNotVerifiedException;
import com.blz.utility.JwtGenerator;
import com.blz.utility.MailServiceProvider;
import com.blz.utility.Util;
...
public  class UserServiceimpl  implements UserService  {
		...
		@Autowired
		private MailResponce mailresponse;
		...
		@Transactional
		@Override
		public UserDemo registration(UserDto userDto) throws UnsupportedEncodingException {
		...
		@Transactional
		@Override
		public UserDemo login(LoginDetails loginDetails) throws UnsupportedEncodingException {
		...
		@Transactional
		@Override
		public boolean verify(String token) throws UnsupportedEncodingException {
		...
		@Override
		public boolean isUserAvailable(String email) throws UnsupportedEncodingException {
		...
		@Override
		public UserDemo updatePassword(String token, UpdatePassword pswd) throws UnsupportedEncodingException {
		...
		@Override
		public UserDemo UpdatePassword(String token, com.blz.DTO.UpdatePassword pswd) {
